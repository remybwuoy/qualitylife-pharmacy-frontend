      ...
      <Header />
        ...
        <div data-aos="fade-in" data-aos-duration="1000" class="container popular-clinics text-center">
            <div class="title-text text-center mb-4">
                ...
                <p class="">
                    A selection of our most popular clinics available through our <a href="#"><span class="text-danger">Online Doctor Service</span></a>. If you require treatments for any of the following conditions, we may be able to help.
                </p>
            </div>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" class="container best-seller text-center">
            <div class="title-text text-center mb-4">
                <h4 class="">Our Best Sellers</h4>
                <p class="">
                    We offer highly competitive prices on all everyday pharmacy items.<a href="#"> <span class="text-danger">Visit the shop</span></a> to pickup the essentials.
                </p>
            </div>
        ...
        <div data-aos="slide-up" data-aos-duration="1000" class="container how-it-works text-center">
            ...
            <div class="row">
                <div class="col-md-3 align-items-stretch">
                    <div class="mx-auto icon-parent-div">
                        <div class="mx-auto pt-4 icon-div">
                            {/* <img src="./assets/images/document.svg"  width="70%" style={{margintop: '10%'}}  alt="svg"/> */}
                            <img src="http://qualitylifepharmacy.teamalfy.online/images/document.svg"  width="60%" style={{margintop: '10%'}} alt="svg"/>                       
                        </div>
                ...
                <div class="col-md-4 align-items-stretch">
                    <div class="mx-auto icon-parent-div">
                        <div class="mx-auto pt-4 icon-div">
                            ...
                            <img src="http://qualitylifepharmacy.teamalfy.online/images/drug.svg"  width="60%" style={{margintop: '10%'}}  alt="pills"/>                       
                        </div>
                ...
                <div class="col-md-3 align-items-stretch">
                    <div class="mx-auto icon-parent-div">
                         <div class="mx-auto pt-4 icon-div">
                            ...
                            <img src="http://qualitylifepharmacy.teamalfy.online/images/delivery.svg"  width="60%" style={{margintop: '10%'}}  alt="svg"/>                       
                        </div>
